...
public class GlobalExceptionHandler {
     ...
     * <p>
     * 处理参数绑定异常
     * 捕获并处理使用@RequestBody 注解引起的参数绑定失败异常
     * </p>
     *
     ...
     * <p>
     * 处理 HTTP 请求方法不支持异常
     * 捕获并处理使用@RequestMapping 注解引起的 HTTP 请求方法不支持异常
     * </p>
     *
     * @param e HTTP 请求方法不支持异常对象，包含不支持的 HTTP 方法和请求路径等信息
     * @return 错误响应，包含错误信息
     */
     ...
     * <p>
     * 处理 HTTP 请求路径不存在异常
     * 捕获并处理使用@RequestMapping 注解引起的 HTTP 请求路径不存在异常
     * </p>
     *
     * @param e HTTP 请求路径不存在异常对象，包含请求路径和请求方法等信息
     * @return 错误响应，包含错误信息
     */
    ...
    /**
     * 处理 JPA 事务异常 (如：Entity 未找到、级联保存错误、类型转换错误等)
     * 这是你刚才遇到 "expression is of type character varying" 错误时会捕获的异常
     */
